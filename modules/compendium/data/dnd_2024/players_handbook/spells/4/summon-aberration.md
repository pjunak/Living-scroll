...
|
 **Eye Ray (Beholderkin Only).** Ranged Attack Roll: Bonus equals your spell attack modifier, range 150 ft. Hit: 1d8 + 3 + the spell’s level Psychic damage. The spirit makes a number of attacks equal to half this spell’s level (round down). |
